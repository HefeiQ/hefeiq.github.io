...
- I created and graded team project - **feature selection of extreme rainfall forecasting**:
    ...
    - **lecture note of ArcMap:** <a href="{{ 'teaching/2017-fall/Team_Project_Phase_3_Classification_Model' | prepend: '/assets/pdf/' | relative_url }}" class="z-depth-0 badge global-theme-block button-block text-uppercase" role="button" target="_blank">PDF</a>
